...
<nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        ...
        @else
        <a class="btn btn-xs btn-warning py-4 px-lg-4" href="{{ route('siswa.dashboard') }}">{{ Auth::user()->name }}</a>
        <a href="{{ route('logout') }}" class="btn btn-primary py-4 px-lg-3 d-none d-lg-block" ><i class='fa fa-unlock'></i>  Logout</a>
        @endguest
    </div>
</nav>
<!-- Navbar End -->