    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                ...
                <p class="card-title-desc">Form ini digunakan untuk <code>Edit Kategori</code>.</p>
            </div>
            <form action="{{ route('admin.savekategori') }}" method="POST">
                ...
                <div class="card-body">
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                            <input class="form-control" type="text" value="{{ $kategori->name }}" id="name" name="name">
                            @if ($errors->has('name'))
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-2">
                            <select class="form-select" name="enabled" id="enabled" required>
                                ...
                                <option value="1" {{ $kategori->enabled  == 1 ? 'selected' : '' }}>Active</option>
                                <option value="0" {{ $kategori->enabled  == 0 ? 'selected' : '' }}>Inactive</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-8">
                            <input class="form-control" type="text" value="{{ $kategori->description }}" id="description" name="description">
